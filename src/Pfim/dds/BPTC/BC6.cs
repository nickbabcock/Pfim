...
namespace Pfim.dds.bptc
{
    public static class BC6
    {
        ...
        struct ModeInfo
        {
            ...
            public ModeInfo(int modeIndex, int mode, int partitions, bool transformed, int indexPrecision, DX10_Helpers.LDRColour[] first, DX10_Helpers.LDRColour[] second)
            {
                ...
                RGBAPrec = new DX10_Helpers.LDRColour[BC6H_MAX_REGIONS][] { first, second };
            }
        }
        ...
        internal struct INTColour
        {
            ...
            public INTColour(DDS_BlockHelpers.RGBColour colour, int pad, bool isSigned)
            {
            ...
            internal DX10_Helpers.LDRColour ToLDRColour(bool isSigned)
            {
                ...
                var c = Color.FromArgb(Util.ColorFloatToByte(1f), Util.ColorFloatToByte(r),
                    Util.ColorFloatToByte(g), Util.ColorFloatToByte(b));
        ...
        {
            new ModeInfo(0, 0x00, 1, true,  3, new DX10_Helpers.LDRColour[] { new DX10_Helpers.LDRColour(10,10,10,0), new DX10_Helpers.LDRColour( 5, 5, 5,0) },    new DX10_Helpers.LDRColour[] { new DX10_Helpers.LDRColour( 5, 5, 5,0), new DX10_Helpers.LDRColour( 5, 5, 5,0) }),
            new ModeInfo(1, 0x01, 1, true,  3, new DX10_Helpers.LDRColour[] { new DX10_Helpers.LDRColour(7,7,7,0),    new DX10_Helpers.LDRColour( 6, 6, 6,0) },    new DX10_Helpers.LDRColour[] { new DX10_Helpers.LDRColour( 6, 6, 6,0), new DX10_Helpers.LDRColour( 6, 6, 6,0) }),
            new ModeInfo(2, 0x02, 1, true,  3, new DX10_Helpers.LDRColour[] { new DX10_Helpers.LDRColour(11,11,11,0), new DX10_Helpers.LDRColour( 5, 4, 4,0) },    new DX10_Helpers.LDRColour[] { new DX10_Helpers.LDRColour( 5, 4, 4,0), new DX10_Helpers.LDRColour( 5, 4, 4,0) }),
            new ModeInfo(3, 0x06, 1, true,  3, new DX10_Helpers.LDRColour[] { new DX10_Helpers.LDRColour(11,11,11,0), new DX10_Helpers.LDRColour( 4, 5, 4,0) },    new DX10_Helpers.LDRColour[] { new DX10_Helpers.LDRColour( 4, 5, 4,0), new DX10_Helpers.LDRColour( 4, 5, 4,0) }),
            new ModeInfo(4, 0x0a, 1, true,  3, new DX10_Helpers.LDRColour[] { new DX10_Helpers.LDRColour(11,11,11,0), new DX10_Helpers.LDRColour( 4, 4, 5,0) },    new DX10_Helpers.LDRColour[] { new DX10_Helpers.LDRColour( 4, 4, 5,0), new DX10_Helpers.LDRColour( 4, 4, 5,0) }),
            new ModeInfo(5, 0x0e, 1, true,  3, new DX10_Helpers.LDRColour[] { new DX10_Helpers.LDRColour(9,9,9,0),    new DX10_Helpers.LDRColour( 5, 5, 5,0) },    new DX10_Helpers.LDRColour[] { new DX10_Helpers.LDRColour( 5, 5, 5,0), new DX10_Helpers.LDRColour( 5, 5, 5,0) }),
            new ModeInfo(6, 0x12, 1, true,  3, new DX10_Helpers.LDRColour[] { new DX10_Helpers.LDRColour(8,8,8,0),    new DX10_Helpers.LDRColour( 6, 5, 5,0) },    new DX10_Helpers.LDRColour[] { new DX10_Helpers.LDRColour( 6, 5, 5,0), new DX10_Helpers.LDRColour( 6, 5, 5,0) }),
            new ModeInfo(7, 0x16, 1, true,  3, new DX10_Helpers.LDRColour[] { new DX10_Helpers.LDRColour(8,8,8,0),    new DX10_Helpers.LDRColour( 5, 6, 5,0) },    new DX10_Helpers.LDRColour[] { new DX10_Helpers.LDRColour( 5, 6, 5,0), new DX10_Helpers.LDRColour( 5, 6, 5,0) }),
            new ModeInfo(8, 0x1a, 1, true,  3, new DX10_Helpers.LDRColour[] { new DX10_Helpers.LDRColour(8,8,8,0),    new DX10_Helpers.LDRColour( 5, 5, 6,0) },    new DX10_Helpers.LDRColour[] { new DX10_Helpers.LDRColour( 5, 5, 6,0), new DX10_Helpers.LDRColour( 5, 5, 6,0) }),
            new ModeInfo(9, 0x1e, 1, false, 3, new DX10_Helpers.LDRColour[] { new DX10_Helpers.LDRColour(6,6,6,0),    new DX10_Helpers.LDRColour( 6, 6, 6,0) },    new DX10_Helpers.LDRColour[] { new DX10_Helpers.LDRColour( 6, 6, 6,0), new DX10_Helpers.LDRColour( 6, 6, 6,0) }),
            new ModeInfo(10, 0x03, 0, false, 4, new DX10_Helpers.LDRColour[] { new DX10_Helpers.LDRColour(10,10,10,0), new DX10_Helpers.LDRColour( 10, 10, 10,0) }, new DX10_Helpers.LDRColour[] { new DX10_Helpers.LDRColour( 0, 0, 0,0), new DX10_Helpers.LDRColour( 0, 0, 0,0) }),
            new ModeInfo(11, 0x07, 0, true,  4, new DX10_Helpers.LDRColour[] { new DX10_Helpers.LDRColour(11,11,11,0), new DX10_Helpers.LDRColour( 9, 9, 9,0) },    new DX10_Helpers.LDRColour[] { new DX10_Helpers.LDRColour( 0, 0, 0,0), new DX10_Helpers.LDRColour( 0, 0, 0,0) }),
            new ModeInfo(12, 0x0b, 0, true,  4, new DX10_Helpers.LDRColour[] { new DX10_Helpers.LDRColour(12,12,12,0), new DX10_Helpers.LDRColour( 8, 8, 8,0) },    new DX10_Helpers.LDRColour[] { new DX10_Helpers.LDRColour( 0, 0, 0,0), new DX10_Helpers.LDRColour( 0, 0, 0,0) }),
            new ModeInfo(13, 0x0f, 0, true,  4, new DX10_Helpers.LDRColour[] { new DX10_Helpers.LDRColour(16,16,16,0), new DX10_Helpers.LDRColour( 4,4, 4,0) },     new DX10_Helpers.LDRColour[] { new DX10_Helpers.LDRColour( 0,0, 0,0),  new DX10_Helpers.LDRColour( 0,0, 0,0) } )
        };
        #endregion Tables
