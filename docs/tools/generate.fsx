...
let githubLink = "http://github.com/nickbabcock/Pfim"

// Specify more information about your project
let info =
  [ "project-name", "Pfim"
    "project-author", "Nick Babcock"
    "project-summary", "Image file format parser"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/Pfim" ]
