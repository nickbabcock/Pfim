...
namespace Pfim.Tests
{
    public class ImageTests
    {
        ...
        [InlineData("dxt1-simple.dds", 95660261486543378, ImageFormat.Rgba32)]
        [InlineData("dxt1-alpha.dds", 12118697689483376531, ImageFormat.Rgba32)]
        [InlineData("dxt3-simple.dds", 15166377643682606551, ImageFormat.Rgba32)]
        [InlineData("dxt5-simple-1x1.dds", 17326382937880120602, ImageFormat.Rgba32)]
        [InlineData("dxt5-simple-odd.dds", 18342173037558988893, ImageFormat.Rgba32)]
        [InlineData("dxt5-simple.dds", 15166377643682606551, ImageFormat.Rgba32)]
        [InlineData("bc2-simple-srgb.dds", 7356768870358274681, ImageFormat.Rgba32)]
        [InlineData("bc3-simple-srgb.dds", 7356768870358274681, ImageFormat.Rgba32)]
        ...
        [InlineData("wose_BC1_UNORM.DDS", 9496393797103213198, ImageFormat.Rgba32)]
        [InlineData("wose_BC1_UNORM_SRGB.DDS", 3816772234230930263, ImageFormat.Rgba32)]
        ...
        [InlineData("bench\\dxt3.dds", 10726572013186846304, ImageFormat.Rgba32)]
        [InlineData("bench\\dxt5.dds", 10726572013186846304, ImageFormat.Rgba32)]
        ...
        [InlineData("bench\\dxt1.dds", 10726572013186846304, ImageFormat.Rgba32)]
        ...
        [InlineData("wose_BC1_UNORM.DDS", 3302044759452356608)]
